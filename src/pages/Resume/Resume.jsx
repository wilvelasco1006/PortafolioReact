        ...
        <div className="resume-container">
            ...
            <section className="resume-section">
                <div className="section-header">
                    ...
                    <h2 className="section-title">Experiencia Ocupacional</h2>
                </div>
                <div className="timeline">
                    <div className="timeline-item">
                        <div className="timeline-content">
                            <h3 className="timeline-title">Desarollador</h3>
                            ...
                            <p className="timeline-description">
                                ...
                                Valencia. Tel. +57 602 321 2100. Funciones: Desarrollar un sitio
                                web 3D interactivo relacionado a enfermedades oculares con
                                React, diseño de interfaz con Figma y control de versiones con
                                Git.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="timeline-item">
                        <div className="timeline-content">
                            ...
                            <p className="timeline-description">
                                <span className="company">Universidad del Valle.</span>
                                Proyecto "SCSM". Cargo: Desarrollador. Docente: Santiago Zuñiga
                                Shaik. Tel. 3104092534. Funciones: Diseñar e implementar un
                                sistema web en Django para el registro detallado de procesos
                                productivos de una empresa de café (ASOMIPRAM). Crear
                                formularios intuitivos con HTML5 para el correcto
                                diligenciamiento y gestión de base de datos en PostgreSQL.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="timeline-item">
                        <div className="timeline-content">
                            <h3 className="timeline-title">Desarollador</h3>
                            <span className="timeline-period">Febrero 2024 - Junio 2024</span>
                            <p className="timeline-description">
                                <span className="company">Universidad del Valle.</span>
                                Proyecto "Beatrix-statistics". Cargo: Desarrollador. Docente:
                                Danny Calvo. Tel. 317 6586357. Funciones: Documentar y apoyar en
                                el desarrollo de funcionalidades de un paquete estadístico en
                                Python diseñado para procesar y visualizar datos meteorológicos
                                a partir de archivos csv. Brindar soporte en la implementación
                                de la interfaz gráfica para la presentación de medidas
                                estadísticas y gráficos. Generar persistencia de datos mediante
                                archivos de texto.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="timeline-item">
                        <div className="timeline-content">
                            <h3 className="timeline-title">Desarrollador</h3>
                            <span className="timeline-period">Marzo 2023 - Julio 2023</span>
                            <p className="timeline-description">
                                <span className="company">Universidad del Valle.</span>
                                ...
                                gastos familiares de 3 familias durante determinado intervalo de
                                tiempo. Crear una interfaz gráfica hecha en Tkinter y
                ...
                <div className="education-list">
                    <div className="education-item">
                        <p className="education-text">
                            ...
                            Yumbo.
                            <span className="education-period">2023 — Actualmente</span>
                        </p>
                    </div>
                    <div className="education-item">
                        <p className="education-text">
