            ...
            <section className="hero-section">
                <div className="hero-content">
                    ...
                    <p className="description">
                        ...
                        contribuir a proyectos innovadores que generen un impacto
                        positivo.
                    </p>
                ...
                <div className="about-content">
                    <div className="about-text">
                        ...
                        <p className="about-description">
                            Soy Tecnólogo en Desarrollo de Software, actualmente en proceso
                            de formación, con conocimientos sólidos en Desarrollo Back-end,
                            Front-end y Bases de Datos. Tengo experiencia aplicando
                            conceptos como la programación orientada a objetos, diseño MVC,
                            maquetación web, uso de frameworks, modelado de datos y control
                            de versiones.
                        </p>
                        <p className="about-commitment">
                            Comprometido con el aprendizaje constante, la mejora continua y
                            la entrega de soluciones tecnológicas de valor.
                        </p>
